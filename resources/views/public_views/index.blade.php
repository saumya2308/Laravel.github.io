...
<div class="ms_loader">
    ...
    <div class="ms_main_wrapper">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box">
                            ...
                            <p>Your one stop solution to explore independent artists, and unbranded indie music. We bring you the best of radio shows music and more. If you're an artist that would like to come on board with us, register with us as an artist and we'll get in touch with you shortly.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box footer_subscribe">
                            <h1 class="footer_title">Register As An Advertiser</h1>
                            <p>Create an Advertiser account and reach your target audience in a whole new way!</p>
                            <form method="post" action="/advertiserreg">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="save_btn">Get Started</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box footer_subscribe">
                            <h1 class="footer_title">Register As An Artist</h1>
                            <p>Create an Artist account with us and start getting your music out there!</p>
                            <form method="post" action="/artistreg">
                                @csrf
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Enter Your Name">
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="save_btn">Sign Up</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="ms_player_wrapper" style="margin-left:5%">
